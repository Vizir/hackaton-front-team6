...
const BaseHome = ({ handleTabPress, selectedTabIndex, renderScreen, }) => {
    return (React.createElement(Screen, { type: ScreenTypes.LOGGED, contentContainerType: ContentContainerTypes.VIEW, hasBackgroundImage: true, title: 'Controle de Gastos', rightIcon: 'filter' },
